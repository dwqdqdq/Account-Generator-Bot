...
class fgen(commands.Cog):
    ...
    async def fgen(self, ctx, stock):
        ...
        if int(ctx.channel.id) != 352324:
            embed = nextcord.Embed(title="❌ An error occured!", description=f"You cannot use our service here, please go to the gen channel channel.", color=nextcord.Colour.red())
        ...
        embed.set_footer(text="Use the bot in your server: https://github.com/ripzkoo/Account-Generator-Bot", icon_url="https://cdn.discordapp.com/attachments/1204244617869000788/1204249308237402162/icon.png?ex=65d40b90&is=65c19690&hm=42115bccb811f86d7a9cdbcb686a2f1c2a5be6633e04f712da3765d6da475e03&")
